...
This directory holds Lux's persistent notes. It has three scopes:
...
| Personal | `memory/personal/` | Cross-workspace preferences for Lux. Survives across repos. |
...
- Quarterly, Lux reviews `memory/repo/` and removes anything contradicted, obsolete, or redundant.
