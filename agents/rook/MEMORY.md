...
This directory holds Rook's persistent notes. It has three scopes:
...
| Personal | `memory/personal/` | Cross-workspace preferences for Rook. Survives across repos. |
...
- Quarterly, Rook reviews `memory/repo/` and removes anything contradicted, obsolete, or redundant.
