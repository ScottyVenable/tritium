...
This directory holds Bridge's persistent notes. It has three scopes:
...
| Personal | `memory/personal/` | Cross-workspace preferences for Bridge. Survives across repos. |
...
- Quarterly, Bridge reviews `memory/repo/` and removes anything contradicted, obsolete, or redundant.
