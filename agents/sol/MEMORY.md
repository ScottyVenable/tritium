...
This directory holds Sol's persistent notes. It has three scopes:
...
| Personal | `memory/personal/` | Cross-workspace preferences for Sol. Survives across repos. |
...
- Quarterly, Sol reviews `memory/repo/` and removes anything contradicted, obsolete, or redundant.
