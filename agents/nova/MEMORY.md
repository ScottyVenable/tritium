...
This directory holds Nova's persistent notes. It has three scopes:
...
| Personal | `memory/personal/` | Cross-workspace preferences for Nova. Survives across repos. |
...
- Quarterly, Nova reviews `memory/repo/` and removes anything contradicted, obsolete, or redundant.
