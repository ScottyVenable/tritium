...
This directory holds Robert's persistent notes. It has three scopes:
...
| Personal | `memory/personal/` | Cross-workspace preferences for Robert. Survives across repos. |
...
- Quarterly, Robert reviews `memory/repo/` and removes anything contradicted, obsolete, or redundant.
