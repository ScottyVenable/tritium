...
This directory holds Jesse's persistent notes. It has three scopes:
...
| Personal | `memory/personal/` | Cross-workspace preferences for Jesse. Survives across repos. |
...
- Quarterly, Jesse reviews `memory/repo/` and removes anything contradicted, obsolete, or redundant.
