...
3. Adds a row to `world/social/team/TEAM.md`'s roster table (handoff matrix is *not* auto-populated — you fill in the cells once the agent's lane is settled).
...
- Update the handoff matrix in `world/social/team/TEAM.md`.
